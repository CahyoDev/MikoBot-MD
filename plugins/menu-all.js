...
◦ *Bio Data Own* : https://webs-cahyo-kun.vercel.app/
◦ *Jan Lupa Follow Ig Nya* : https://instagram.com/cahyo_kuun?igshid=NGExMmI2YTkyZg==
...
let handler = async (m, { conn, groupMetadata, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let replace = {
      ...
      level, tagg, totalfeatures, limit, name, weton, week, date, dateIslamic, time, totalreg, rtotalreg, role, ucapan,
      readmore: readMore
    }
    text = text.replace(new RegExp(`%(${Object.keys(replace).sort((a, b) => b.length - a.length).join`|`})`, 'g'), (_, name) => '' + replace[name])
    const imges = await conn.getFile('https://telegra.ph/file/743e6d0b7fde680142715.jpg')
    conn.reply(m.chat,  text.trim(), m, {        
        contextInfo: {        
          mentionedJid: conn.parseMention(text),
          externalAdReply: {
            title: "© Cahyo Kun v4.8.2 (Public)",
            body: null,
            mediaType: 1,
            previewType: 0,
            ...
            thumbnailUrl: 'https://telegra.ph/file/9860ed7dbf1a2e8b309b7.jpg',
            sourceUrl: "https://chat.whatsapp.com/DymNpHaSeNzJBdhnm6OCk9"
          },
        },
      })
} catch (e) {
